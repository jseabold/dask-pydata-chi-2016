...
def create_accounts_json(num_files, n, k):
    ...
    ids, names2, wealth_mag, wealth_trend, freq = account_params(k)

    for i in range(num_files):
        seq = json_entries(n, ids, names2, wealth_mag, wealth_trend, freq)
...
def json_entries(n, ids, names, wealth_mag, wealth_trend, freq):
    df = account_entries(n, ids, names, wealth_mag, wealth_trend, freq)
